...
* How to combine date and time data types in R dataframe into timestamp and how to compare/do computation of the timestamps. For example, I created a sample dataframe called demo1 with three
...
```
*   How to transform character into timestamp datatype in R dataframe.
...
* How to use cast to transform a character time into time type when reading data from database into R.
